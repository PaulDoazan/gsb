 ...
 */
	...
	public function getLesVisiteurs(){
        ...
        /**
         * Récupère les tarifs appliqués pour les frais forfait
         * 
	...
	*/
	...
	public function majMontantValide($idUtilisateur, $mois, $montant){
        ...
        /**
         * Récupère les informations du visiteur dont on créé la fiche en pdf
         * 
         * @param type $idUtilisateur
         * @return tableau associatif
         */
	public function getInfosPdf($idUtilisateur){
		$req = "select utilisateur.nom as nom, utilisateur.prenom as prenom, utilisateur.idUtilisateur as id from utilisateur where idUtilisateur = '$idUtilisateur'";
		$res = PdoGsb::$monPdo->query($req);
		$lesLignes = $res->fetch();
		return $lesLignes;
	}
